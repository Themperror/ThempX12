...
bool Themp::Util::Contains(const std::string& sourceString, const std::string& searchString, bool caseSensitive)
{
...
bool Themp::Util::Contains(const std::string_view& sourceString, const std::string_view& searchString, bool caseSensitive)
{
